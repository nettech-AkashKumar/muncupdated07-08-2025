...
>>>>>>> d845bade3879e8326e8c3856ec55a3a746d95894
import {
  arrow_default,
...
import {
  ...
  useIsRTL
<<<<<<< HEAD
} from "./chunk-6R6CYZ2M.js";
=======
} from "./chunk-WE4WY3R2.js";
>>>>>>> d845bade3879e8326e8c3856ec55a3a746d95894
import {
  require_classnames
...
var divWithClassName_default = (className) => (
  ...
  React13.forwardRef((p, ref) => (0, import_jsx_runtime9.jsx)("div", {
    ...p,
    ref,
...
var CardBody = React25.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CardImg = React29.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var CardImgOverlay = React30.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CardLink = React31.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "a",
  ...props
...
var CardSubtitle = React32.forwardRef(({
  className,
  bsPrefix,
...
var CardText = React33.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "p",
  ...props
...
var CardGroup = React36.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function useMounted2() {
  const mounted = (0, import_react29.useRef)(true);
  const isMounted = (0, import_react29.useRef)(() => mounted.current);
...
var CarouselCaption = React37.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function map(children, func) {
  let index = 0;
  return React39.Children.map(children, (child) => React39.isValidElement(child) ? func(child, index++) : child);
}
function forEach(children, func) {
  let index = 0;
  React39.Children.forEach(children, (child) => {
    if (React39.isValidElement(child)) func(child, index++);
  });
}
function hasChildOfType(children, type) {
  return React39.Children.toArray(children).some((child) => React39.isValidElement(child) && child.type === type);
}
      ...
      children: [indicators && (0, import_jsx_runtime35.jsx)("div", {
        ...
        children: map(children, (child, index) => {
          ...
          return slide ? (0, import_jsx_runtime35.jsx)(TransitionWrapper_default, {
            ...
            addEndListener: transitionEndListener,
            children: (status, innerProps) => React40.cloneElement(child, {
              ...innerProps,
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react35.useReducer)((revision) => revision + 1, 0);
  return dispatch;
}
...
var useIsomorphicEffect_default2 = isDOM2 || isReactNative2 ? import_react45.useLayoutEffect : import_react45.useEffect;
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false) return ref;
  const warningRef = (0, import_react46.useCallback)((refValue) => {
...
var DropdownMenu2 = React57.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react47.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react47.useContext)(DropdownContext_default2);
...
var DropdownToggle2 = React58.forwardRef(({
  ...
  const dropdownContext = (0, import_react48.useContext)(DropdownContext_default);
...
var FormCheck = React69.forwardRef(({
  ...
  const innerFormContext = (0, import_react52.useMemo)(() => ({
...
var FormGroup = React72.forwardRef(({
  ...
  const context6 = (0, import_react54.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var Switch = React77.forwardRef((props, ref) => (0, import_jsx_runtime70.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Modal = (0, import_react69.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime82.jsx)(import_jsx_runtime82.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime82.jsxs)(import_jsx_runtime82.Fragment, {
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react82.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
  ...
  (_ref2, ref) => {
    ...
    return (0, import_jsx_runtime131.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime131.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime131.jsx)(Transition, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
...
var TabPane = React134.forwardRef(({
  ...
  return (0, import_jsx_runtime135.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime135.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime135.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
var ToastFade = React137.forwardRef((props, ref) => (0, import_jsx_runtime139.jsx)(Fade_default, {
  ...props,
  ref,
...
var Toast = React141.forwardRef(({
  ...
  return (0, import_jsx_runtime143.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime143.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
