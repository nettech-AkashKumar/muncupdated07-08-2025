...
var Typography = React33.forwardRef(function Typography2(inProps, ref) {
  const {
    color: color2,
    ...themeProps
  } = useDefaultProps2({
...
function useForkRef(...refs) {
  const cleanupRef = React34.useRef(void 0);
  const refEffect = React34.useCallback((instance) => {
...
function getReactElementRef(element) {
  var _a;
  if (parseInt(React35.version, 10) >= 19) {
...
var Portal = React36.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children: children2,
    container,
    disablePortal = false
  ...
  const handleRef = useForkRef(React36.isValidElement(children2) ? getReactElementRef(children2) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React36.isValidElement(children2)) {
      const newProps = {
        ref: handleRef
      };
      return React36.cloneElement(children2, newProps);
    }
    return children2;
  }
...
var PopperTooltip = React37.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children: children2,
    direction,
  ...
  const [resolvedAnchorElement, setResolvedAnchorElement] = React37.useState(resolveAnchorEl(anchorEl));
  React37.useEffect(() => {
...
var Popper = React37.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children: children2,
...
var Popper3 = React38.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime24.jsx)(PopperRoot, {
    as: component,
...
var SvgIcon = React40.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime25.jsxs)(SvgIconRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    focusable: "false",
    color: htmlColor,
    ...
    ownerState,
    children: [hasSvgAsChild ? children2.props.children : children2, titleAccess ? (0, import_jsx_runtime25.jsx)("title", {
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime26.jsx)(SvgIcon_default, {
...
function useControlled(props) {
  ...
  } = React42.useRef(controlled !== void 0);
  const [valueState, setValue] = React42.useState(defaultProp);
  ...
  const setValueIfUncontrolled = React42.useCallback((newValue) => {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
function useLazyRef(init, initArg) {
  const ref = React44.useRef(UNINITIALIZED);
...
var LazyRipple = class _LazyRipple {
  ...
  static use() {
    ...
    const [shouldMount, setShouldMount] = React45.useState(false);
    ripple.shouldMount = shouldMount;
    ripple.setShouldMount = setShouldMount;
    React45.useEffect(ripple.mountEffect, [shouldMount]);
    return ripple;
  }
  mount() {
    if (!this.mounted) {
...
var TouchRipple = React52.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  return (0, import_jsx_runtime28.jsx)(TouchRippleRoot, {
...
var ButtonBase = React53.forwardRef(function ButtonBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime29.jsxs)(ButtonBaseRoot, {
    as: ComponentProp,
    className: clsx_default(classes.root, className),
    ownerState,
    onBlur: handleBlur,
    ...
    ...buttonProps,
    ...other,
    children: [children2, enableTouchRipple ? (0, import_jsx_runtime29.jsx)(TouchRipple_default, {
      ref: handleRippleRef,
      center: centerRipple,
      ...TouchRippleProps
    }) : null]
...
var CircularProgress = React54.forwardRef(function CircularProgress2(inProps, ref) {
  ...
  return (0, import_jsx_runtime30.jsx)(CircularProgressRoot, {
    className: clsx_default(classes.root, className),
    style: {
      width: size,
      height: size,
    ...
    ...rootProps,
    ...other,
    children: (0, import_jsx_runtime30.jsx)(CircularProgressSVG, {
      className: classes.svg,
      ownerState,
      viewBox: `${SIZE / 2} ${SIZE / 2} ${SIZE} ${SIZE}`,
      children: (0, import_jsx_runtime30.jsx)(CircularProgressCircle, {
...
var IconButton = React55.forwardRef(function IconButton2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiIconButton"
  });
  ...
  const loadingIndicator = loadingIndicatorProp ?? (0, import_jsx_runtime31.jsx)(CircularProgress_default, {
  ...
  return (0, import_jsx_runtime31.jsxs)(IconButtonRoot, {
    ...
    (0, import_jsx_runtime31.jsx)("span", {
      className: classes.loadingWrapper,
      style: {
        display: "contents"
      },
      children: (0, import_jsx_runtime31.jsx)(IconButtonLoadingIndicator, {
...
true ? IconButton.propTypes = {
  ...
  children: chainPropTypes(import_prop_types37.default.node, (props) => {
    const found = React55.Children.toArray(props.children).some((child) => React55.isValidElement(child) && child.props.onClick);
    if (found) {
...
true ? Button.propTypes = {
   ...
   * @default 'center'
   */
  loadingPosition: import_prop_types38.default.oneOf(["center", "end", "start"]),
  /**
   * The size of the component.
   * `small` is equivalent to the dense button styling.
   * @default 'medium'
