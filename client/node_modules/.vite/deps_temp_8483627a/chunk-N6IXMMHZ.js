...
function createGrid(options = {}) {
  ...
  const useUtilityClasses9 = (ownerState, theme) => {
    const {
      container,
      direction,
      spacing: spacing2,
  ...
  const Grid2 = React23.forwardRef(function Grid3(inProps, ref) {
    ...
    const classes = useUtilityClasses9(ownerState, theme);
    return (0, import_jsx_runtime13.jsx)(GridRoot, {
      ...
      children: React23.Children.map(children2, (child) => {
        var _a;
        if (React23.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
function ThemeProvider3({
  ...
  const noVarsTheme = React29.useMemo(() => {
...
var SvgIcon = React33.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React33.isValidElement(children2) && children2.type === "svg";
  const ownerState = {
    ...props,
    color: color2,
    component,
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime23.jsx)(SvgIcon_default, {
  ...
  return React34.memo(React34.forwardRef(Component));
}
...
function useForkRef(...refs) {
  const cleanupRef = React37.useRef(void 0);
  const refEffect = React37.useCallback((instance) => {
...
var refType = import_prop_types22.default.oneOfType([import_prop_types22.default.func, import_prop_types22.default.object]);
...
var elementTypeAcceptingRef_default = chainPropTypes(import_prop_types23.default.elementType, elementTypeAcceptingRef);
...
var LazyRipple = class _LazyRipple {
  ...
  static use() {
    ...
    const [shouldMount, setShouldMount] = React39.useState(false);
    ripple.shouldMount = shouldMount;
    ripple.setShouldMount = setShouldMount;
    React39.useEffect(ripple.mountEffect, [shouldMount]);
    return ripple;
  }
  mount() {
    if (!this.mounted) {
...
function getChildMapping(children2, mapFn) {
  ...
  if (children2) import_react8.Children.map(children2, function(c) {
    return c;
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (import_react10.default.Children.count(props[propName]) !== 2) return new Error('"' + propName + '" must be exactly two transition components.');
    return null;
  }
} : {};
...
var CircularProgress = React48.forwardRef(function CircularProgress2(inProps, ref) {
  ...
  return (0, import_jsx_runtime27.jsx)(CircularProgressRoot, {
    className: clsx_default(classes.root, className),
    style: {
      width: size,
      height: size,
    ...
    ...rootProps,
    ...other,
    children: (0, import_jsx_runtime27.jsx)(CircularProgressSVG, {
      className: classes.svg,
      ownerState,
      viewBox: `${SIZE / 2} ${SIZE / 2} ${SIZE} ${SIZE}`,
      children: (0, import_jsx_runtime27.jsx)(CircularProgressCircle, {
...
var IconButton = React49.forwardRef(function IconButton2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiIconButton"
  });
  ...
  const loadingIndicator = loadingIndicatorProp ?? (0, import_jsx_runtime28.jsx)(CircularProgress_default, {
  ...
  return (0, import_jsx_runtime28.jsxs)(IconButtonRoot, {
    ...
    (0, import_jsx_runtime28.jsx)("span", {
      className: classes.loadingWrapper,
      style: {
        display: "contents"
      },
      children: (0, import_jsx_runtime28.jsx)(IconButtonLoadingIndicator, {
...
true ? IconButton.propTypes = {
  ...
  children: chainPropTypes(import_prop_types32.default.node, (props) => {
    const found = React49.Children.toArray(props.children).some((child) => React49.isValidElement(child) && child.props.onClick);
    if (found) {
...
var Typography = React50.forwardRef(function Typography2(inProps, ref) {
  ...
  return (0, import_jsx_runtime29.jsx)(TypographyRoot, {
    as: Component,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
true ? Typography.propTypes = {
   ...
   * @default 'inherit'
   */
  align: import_prop_types33.default.oneOf(["center", "inherit", "justify", "left", "right"]),
  /**
   * The content of the component.
   */
   ...
   * @default false
   */
  gutterBottom: import_prop_types33.default.bool,
  /**
   ...
   * @default false
   */
  noWrap: import_prop_types33.default.bool,
  /**
   * If `true`, the element will be a paragraph element.
   * @default false
   * @deprecated Use the `component` prop instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](https://mui.com/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   */
  paragraph: import_prop_types33.default.bool,
  /**
   * @ignore
   */
   ...
   * }
   */
  variantMapping: import_prop_types33.default.object
} : void 0;
var Typography_default = Typography;
...
function getReactElementRef(element) {
  var _a;
  if (parseInt(React51.version, 10) >= 19) {
...
var Portal = React52.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React52.isValidElement(children2) ? getReactElementRef(children2) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React52.isValidElement(children2)) {
      ...
      return React52.cloneElement(children2, newProps);
    }
    return children2;
  }
...
var PopperTooltip = React53.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children: children2,
    direction,
  ...
  const tooltipRef = React53.useRef(null);
  const ownRef = useForkRef(tooltipRef, forwardedRef);
  const popperRef = React53.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React53.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React53.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React53.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React53.useState(resolveAnchorEl(anchorEl));
  React53.useEffect(() => {
...
var Popper = React53.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children: children2,
  ...
  return (0, import_jsx_runtime30.jsx)(Portal_default, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime30.jsx)(PopperTooltip, {
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
var Popper3 = React54.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiPopper"
  ...
  return (0, import_jsx_runtime31.jsx)(PopperRoot, {
    as: component,
...
var Button = React57.forwardRef(function Button2(inProps, ref) {
  ...
  const loadingId = useId_default(idProp);
  const loadingIndicator = loadingIndicatorProp ?? (0, import_jsx_runtime32.jsx)(CircularProgress_default, {
    "aria-labelledby": loadingId,
    color: "inherit",
    size: 16
  });
  ...
  const startIcon = (startIconProp || loading && loadingPosition === "start") && (0, import_jsx_runtime32.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp || (0, import_jsx_runtime32.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  const endIcon = (endIconProp || loading && loadingPosition === "end") && (0, import_jsx_runtime32.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp || (0, import_jsx_runtime32.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  ...
  const loader = typeof loading === "boolean" ? (
    ...
    (0, import_jsx_runtime32.jsx)("span", {
      className: classes.loadingWrapper,
      style: {
        display: "contents"
      },
      children: loading && (0, import_jsx_runtime32.jsx)(ButtonLoadingIndicator, {
        className: classes.loadingIndicator,
        ownerState,
  ...
  return (0, import_jsx_runtime32.jsxs)(ButtonRoot, {
    ownerState,
...
@mui/system/esm/index.js:
   ...
   *)
*/
<<<<<<<< HEAD:client/node_modules/.vite/deps/chunk-LUUHGL75.js
//# sourceMappingURL=chunk-LUUHGL75.js.map
========
<<<<<<<< Updated upstream:client/node_modules/.vite/deps/chunk-LFMYF7DW.js
<<<<<<< Updated upstream
=======
<<<<<<<< Updated upstream:client/node_modules/.vite/deps/chunk-LFMYF7DW.js
>>>>>>> Stashed changes
//# sourceMappingURL=chunk-LFMYF7DW.js.map
========
//# sourceMappingURL=chunk-N6IXMMHZ.js.map
>>>>>>>> Stashed changes:client/node_modules/.vite/deps_temp_8483627a/chunk-N6IXMMHZ.js
<<<<<<< Updated upstream
=======
========
//# sourceMappingURL=chunk-N6IXMMHZ.js.map
>>>>>>>> Stashed changes:client/node_modules/.vite/deps_temp_8483627a/chunk-N6IXMMHZ.js
>>>>>>> Stashed changes
>>>>>>>> 3ac9c546e74016aba8d2d23266006b5dfe1bb0d7:client/node_modules/.vite/deps_temp_8483627a/chunk-N6IXMMHZ.js
