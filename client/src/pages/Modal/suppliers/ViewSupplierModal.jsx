                            ...
                            <div className="card-body position-relative z-1">
                                <div className="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-3">
                                    <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                        ...
                                        <div className>
                                            <p className="text-primary fs-14 fw-medium mb-1">{supplier.supplierCode}</p>
                                            <h6 className="mb-2"> {supplier.firstName} {supplier.lastName} <img src={Confirm} alt="confirme" className="ms-1" /></h6>
                                    ...
                                    <div className="card-body border-0 shadow shadow-none">
                                        <ul className="d-flex justify-content-between align-items-center flex-wrap gap-2 p-0 m-0 list-unstyled">
                                            ...
                                            <li>
                                                ...
                                                <p className="d-flex align-items-center"> {supplier.companyWebsite}<i className="isax isax-link fs-14 ms-1 text-primary" /></p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
